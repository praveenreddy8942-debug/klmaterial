...
const GITHUB_REPO = "2500031148/klmaterial";
...
const _urlSub = _urlParams.get('sub');

let activeYear = "all";
let activeSemester = "all";
let activeSubject = "all";

if (_urlSub && typeof subjects !== 'undefined' && subjects[_urlSub]) {
  activeSubject = _urlSub;
  activeYear = subjects[_urlSub].year.toString();
  activeSemester = subjects[_urlSub].semester.toString();
}
